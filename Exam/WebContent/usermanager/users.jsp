			...
			<div id="main">
				...
				<div class="user_manager">
					<p>
						...
						<input type="button" value="添加" onclick="document.location='/Exam/usermanager/userAdd.html'" style="width: 54px; height: 20px; margin-left: 15px;">
						<input type="submit" disabled id="upBtn" value="修改"   style="width: 54px; height: 20px; margin-left: 15px;">
					...
					<table width="100%" class="table" cellspacing="1"
						...
						<!-- 显示当前页的数据行内容    start -->
                         <c:forEach items="${requestScope.userList}" var="user">
                            ...
                            <input name="ck" type="checkbox" class="STYLE2" value="${user.userId}" />
                            </div></td>
							...
							<td style="color: #666666; font-size: 14px; text-align: center;">
                                 ...
                                 <!-- 作者：老杨 -->
                                 <!-- 修改日期:2017-05-15 -->          
								<a href="${pageContext.request.contextPath}/UserDeleteServlet?userId=${user.userId}&pageNo=${requestScope.pageNo}">删除当前用户</a>
							</td>
						</tr>
